...
MELLI_NUMBER: DIGIT DIGIT DIGIT DIGIT DIGIT DIGIT DIGIT DIGIT DIGIT DIGIT? | DIGIT DIGIT DIGIT DIGIT DIGIT DIGIT DIGIT DIGIT DIGIT? | DIGIT DIGIT DIGIT DIGIT DIGIT DIGIT DIGIT DIGIT? | DIGIT DIGIT DIGIT DIGIT DIGIT DIGIT DIGIT? | DIGIT DIGIT DIGIT DIGIT DIGIT DIGIT? | DIGIT DIGIT DIGIT DIGIT DIGIT? | DIGIT DIGIT DIGIT DIGIT? | DIGIT DIGIT DIGIT?;
EMAIL: LOCAL_SUBPART '@' DOMAIN_SUBPART '.' DOMAIN_SUBPART;
URL: (URL_SCHEME? URL_HOSTNAME (':' URL_PORT)? ('/' URL_PATH)? ('?' URL_QUERY)? ('#' URL_FRAGMENT)?);
URL_HOSTNAME: URL_HOSTNAME_IPV4 | URL_HOSTNAME_IPV6 | URL_HOSTNAME_DOMAIN;
